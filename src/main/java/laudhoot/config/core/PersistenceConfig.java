...
@EnableJpaRepositories("laudhoot.core.repository")
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() throws ClassNotFoundException {
        ...
        jpaProterties.put(PROPERTY_NAME_HIBERNATE_UPDATE_SCHEMA, environment.getRequiredProperty(PROPERTY_NAME_HIBERNATE_UPDATE_SCHEMA));
